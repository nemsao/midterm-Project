...
adminRouter.get   ('/project/details/:id',controllerAdmin.projectDetailsController)
adminRouter.post  ('/project/add/:username',controllerAdmin.authorizeMiddleware,controllerAdmin.projectAddsController)
adminRouter.put   ('/project/edit/:oldname',controllerAdmin.authorizeMiddleware,controllerAdmin.projectEditsController)
adminRouter.delete('/project/delete/:name',controllerAdmin.authorizeMiddleware,controllerAdmin.projectDeleteController)
